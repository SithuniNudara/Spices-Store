...
public class InAttendance extends javax.swing.JFrame {

    public static String email = "";

    public InAttendance(String email) {
        this.email = email;
        initComponents();
        dashimage();
        init();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String query = "SELECT * FROM `inattendance` WHERE `employee_email` = '" + email + "' AND `date_time` LIKE '" + currentDate + "%'";
        ...
        if (rs.next()) {
            ...
            MySQL.executeIUD("INSERT INTO `inattendance` (`employee_email`, `date_time`) VALUES('" + email + "', '" + currentDateTime + "')");
            JOptionPane.showMessageDialog(this, "Successfully Marked Attendance!");
            this.dispose();
        }
    } catch (Exception e) {
        Logger logger = Splash.getLoggerObject();
        logger.log(Level.WARNING, "Insert attendance error", e);
    }
