...
public class ConfirmMsg2 extends javax.swing.JFrame {
    ...
    public ConfirmMsg2() {
        ...
        FlatSVGIcon icon = new FlatSVGIcon("resources/info.svg", jLabel1.getWidth(), jLabel1.getHeight());
    ...
    private void initComponents() {
        ...
        jButton2.setBackground(new java.awt.Color(252, 223, 15));
        ...
        jLabel2.setText("Do You Want Add or View invoices?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ViewInvcoices vi = new ViewInvcoices();
        this.dispose();
        vi.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConfirmMsg2().setVisible(true);
            }
        });
    }
